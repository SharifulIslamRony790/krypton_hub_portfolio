...
# Tailwind gray-100 to gray-200
bg_image = create_gradient_bg(TARGET_SIZE, (243, 244, 246), (229, 231, 235))
...
def process_image(filepath):
    try:
        ...
        # Remove background using rembg WITH Alpha Matting for high quality
        # edges
        output_bytes = remove(
            input_bytes,
            session=session,
        ...
        # Enhance foreground (the person) to look more professional (slightly
